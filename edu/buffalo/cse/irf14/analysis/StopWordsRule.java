...
public class StopWordsRule extends TokenFilter {
	...
	private static final String STOP_WORDS_List = "a,able,about,across,after,all,almost,also,am,"
			+ "among,an,and,any,are,as,at,be,because,been,but,by,can,cannot,could,dear,did,do,does,"
	...
	public boolean increment() throws TokenizerException {
		...
		if(token!=null && token.getTermText()!=null) {
			...
			if(STOP_WORDS_List.indexOf(text)>-1) {
				stream.remove();
			}
		}		
